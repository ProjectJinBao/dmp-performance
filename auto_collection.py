...
if __name__ == '__main__':
    ...
    main(count=360, hatch_rate=50, users=1500)
    time.sleep(60)
    main(count=360, hatch_rate=50, users=1700)
    time.sleep(60)
    main(count=360, hatch_rate=50, users=1900)
    time.sleep(60)
    # main(count=720, hatch_rate=50, users=1800)
    # time.sleep(60)
