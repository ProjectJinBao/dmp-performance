...
if __name__ == '__main__':
    ...
    main(count=1460, hatch_rate=50, users=1600)
    time.sleep(60)
    main(count=1460, hatch_rate=50, users=1700)
    time.sleep(60)
    main(count=1460, hatch_rate=50, users=1800)
    time.sleep(60)
    main(count=1460, hatch_rate=50, users=1900)
    # time.sleep(60)
