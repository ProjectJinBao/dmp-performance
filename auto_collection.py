...
if __name__ == '__main__':
    ...
    main(count=1460, hatch_rate=50, users=300)
    time.sleep(60)
    main(count=1460, hatch_rate=50, users=500)
    time.sleep(60)
    main(count=1460, hatch_rate=50, users=800)
    time.sleep(60)
    main(count=1460, hatch_rate=50, users=1000)
    time.sleep(60)
    main(count=1460, hatch_rate=50, users=1200)
    # time.sleep(60)
