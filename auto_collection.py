...
if __name__ == '__main__':
    ...
    main(count=740, hatch_rate=50, users=700)
    time.sleep(60)
    main(count=740, hatch_rate=50, users=800)
    time.sleep(60)
    main(count=740, hatch_rate=50, users=900)
    time.sleep(60)
    main(count=740, hatch_rate=50, users=1000)
    time.sleep(60)
    main(count=740, hatch_rate=50, users=1100)
    time.sleep(60)
